            ...
            <form className="">
                <div className="mb-[0.625rem] md:bg-[#141414] rounded-[3.125rem] p-[1.25rem] md:p-[3.125rem] relative mb-[3.4375rem]">
                    ...
                    <div className="mt-[1.8125rem] flex flex-wrap gap-[0.625rem] justify-between">
                        ...
                        <Select className="w-[calc(50%-1rem/2)] md:w-[calc(50%-1rem/2)] mb-[0.625rem]" selectClassName="text-[1.25rem] leading-[1.875rem] w-full h-[3.75rem] rounded-[1.25rem] px-[1.25rem] border-2 border-[#525252]" placeholder="Location" options={ageGroup} />
