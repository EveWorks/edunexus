        ...
        <>
            {!isMobile ? (
                ...
                <div className="bg-[#141414] rounded-bl-[1.5625rem] rounded-br-[1.5625rem] py-[1.25rem] px-[1.1875rem] flex flex-wrap items-center justify-between">
                    <div className="w-[33.33%]">
                        <Button className="bg-[#0c0c0c] w-[30px] h-[30px] rounded-[30px] p-0" variant="text" color="primary" onClick={OpenMenu}>
                    ...
                    <div className="w-[33.33%] flex items-center justify-end">
                        <Button className="bg-[#0c0c0c] w-[30px] h-[30px] rounded-[30px] p-0 text-[15px] leading-[21px]" variant="text" color="primary">
                            ST
                        </Button>
                    </div>
                    <div className="w-[50%] text-center text-[20px] leading-[21px] flex items-center mt-[15px]">Conversation 8 <TbEdit className="ml-[5px] w-[1.125rem] h-[1.125rem] text-[#525252]" /></div>
                    <div className="w-[50%] flex justify-end mt-[15px]">
                        <Select className="w-fit font-medium" suffixClassName="text-[#151515]" selectClassName="text-[12px] leading-[1.875rem] min-w-[92px] w-fit h-[22px] rounded-[10px] py-[7px] px-[10px] border border-primary bg-primary" placeholder="Course" options={courses} />
                    </div>
                </div>
            )}
        </>
