      ...
      {chats?.length > 0 ? (
        <div className="h-full overflow-auto ps-[2.6875rem] pr-[1.25rem] pb-[2.6875rem]">
          <ul className="h-[calc(100dvh-300px)] overflow-y-auto custom-scrollbar">
            {chats?.map((item: any) => {
              return (
                <li className="flex mt-[4.375rem]" key={item.data}>
                  {/* {item?.alinda ? ( */}
        ...
        <div className="flex flex-col items-center justify-center h-full">
          ...
          <div className="flex items-center justify-center">
            <span className="text-[1.25rem] leading-[0.9375rem] font-medium text-[#FFFFFF] border border-[#525252] rounded-[0.625rem] p-[0.5rem] mr-[1.25rem]">
              Mathematics
            </span>
